...
function js_fs_write_file(path,data,len) { const pathStr = UTF8ToString(path); if (typeof Module.fsWriteFile === 'function') { const arr = new Uint8Array(len); for (let i = 0; i < len; i++) { arr[i] = HEAPU8[data + i]; } const success = Module.fsWriteFile(pathStr, arr); return success ? len : -1; } return -1; }
function js_fs_create_file(path) { const pathStr = UTF8ToString(path); if (typeof Module.fsCreateFile === 'function') { return Module.fsCreateFile(pathStr) ? 1 : 0; } return 0; }
...
function _o_time_get() { return Module.time_get(); }
function _o_puts(str) { Module.print2(UTF8ToString(str), false); }
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = OtiumOS;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = OtiumOS;
